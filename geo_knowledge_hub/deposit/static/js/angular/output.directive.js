    ...
    <div class="row">
      <div class="col-md-6">
        <div class="form-group schema-form-text has-feedback">
          <label class="control-label " for="tools-{{ $ctrl.item.id }}-output_doi">DOI of the Output</label>
          <input type="text" step="any" placeholder="" class="form-control"
                id="tools-{{ $ctrl.item.id }}-output_doi"
                ng-model="$ctrl.item.output_doi" name="tools-{{ $ctrl.item.id }}-output_doi">
        </div>
      </div>
