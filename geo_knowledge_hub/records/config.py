...
RECORDS_REST_ENDPOINTS = {
    'recid': dict(
        ...
        search_type=None,
        record_serializers={
            'application/json': ('geo_knowledge_hub.records.serializers'
                                 ':json_v1_response'),
        },
        search_serializers={
            'application/json': ('geo_knowledge_hub.records.serializers'
        ...
        record_loaders={
            'application/json': ('geo_knowledge_hub.records.loaders'
                                 ':json_v1'),
        },
        list_route='/records/',
...
"""REST API for geo-knowledge-hub."""
...
"""Records UI for geo-knowledge-hub."""
...
GEO_KNOWLEDGE_HUB_ENDPOINTS_ENABLED = True
